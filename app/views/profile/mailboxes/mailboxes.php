...
$baseUrl = BASE_PATH . '/app/controllers/profile/index.php';
...
$listTitle = 'Mailboxes';
$listSummaryTags = [sprintf('%d mailboxes', count($personalMailboxes))];
...
$detailWrapperId = 'profile-mailbox-detail-panel';
