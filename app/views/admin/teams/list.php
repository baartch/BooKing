...
$listRowActions = static function (array $team) use ($baseUrl, $baseQuery): string {
    ...
    ?>
      <div class="buttons are-small is-justify-content-flex-end" data-list-ignore>
        <a href="<?php echo htmlspecialchars($editLink); ?>" class="button" aria-label="Edit team" title="Edit team">
          <span class="icon"><i class="fa-solid fa-pen"></i></span>
        </a>
        <form method="POST" action="" onsubmit="return confirm('Delete this team?');" data-list-ignore>
          <?php renderCsrfField(); ?>
