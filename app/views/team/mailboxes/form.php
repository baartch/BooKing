...
$cancelUrl = $cancelUrl ?? (BASE_PATH . '/app/controllers/team/index.php?tab=mailboxes');
...
<div class="box">
  ...
  <form method="POST" action="<?php echo BASE_PATH; ?>/app/controllers/team/mailbox_form.php">
    ...
    <?php endif; ?>
    <?php if (!$isEdit && !$showTeamSelect): ?>
      <input type="hidden" name="team_id" value="<?php echo (int) ($teams[0]['id'] ?? 0); ?>">
    <?php endif; ?>
