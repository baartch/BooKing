...
$listRowActions = static function (array $task) use ($baseUrl, $baseQuery, $activeTeamId, $searchQuery): string {
    ...
    ?>
      <div class="buttons are-small is-justify-content-flex-end">
        <a href="<?php echo htmlspecialchars($editLink); ?>" class="button" aria-label="Edit task" title="Edit task" data-list-ignore>
          <span class="icon"><i class="fa-solid fa-pen"></i></span>
        </a>
        <form method="POST" action="<?php echo BASE_PATH; ?>/app/controllers/team/tasks_delete.php" onsubmit="return confirm('Delete this task?');" data-list-ignore>
          <?php renderCsrfField(); ?>
