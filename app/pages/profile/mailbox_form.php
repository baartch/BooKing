        ...
        if (!$errors) {
            try {
                if ($isCreate) {
                    ...
                    header('Location: ' . BASE_PATH . '/app/pages/profile/index.php?tab=mailboxes&notice=mailbox_created');
                    exit;
                }
                ...
                if (!$existingMailbox) {
                    ...
                    header('Location: ' . BASE_PATH . '/app/pages/profile/index.php?tab=mailboxes&notice=mailbox_updated');
                    exit;
                }
            } catch (Throwable $error) {
        ...
        <div class="container is-fluid">
          <div class="level mb-4">
            ...
            <div class="level-right">
              <a href="<?php echo BASE_PATH; ?>/app/pages/profile/index.php?tab=mailboxes" class="button">Back to Mailboxes</a>
            </div>
          </div>
            ...
            <form method="POST" action="" class="columns is-multiline">
              ...
              <div class="column is-12">
                <div class="buttons">
                  ...
                  <a href="<?php echo BASE_PATH; ?>/app/pages/profile/index.php?tab=mailboxes" class="button">Cancel</a>
                </div>
              </div>
            </form>
          </div>
