    ...
    public static function isRequest(): bool {
        if (isset($_SERVER['HTTP_HX_REQUEST'])) {
            return strtolower((string) $_SERVER['HTTP_HX_REQUEST']) === 'true'
                || (string) $_SERVER['HTTP_HX_REQUEST'] === '1';
        }

        return isset($_SERVER['HTTP_HX_TARGET'])
            || isset($_SERVER['HTTP_HX_TRIGGER'])
            || isset($_SERVER['HTTP_HX_BOOSTED'])
