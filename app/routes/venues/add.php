    ...
    if (!$errors && in_array($action, ['create', 'update'], true)) {
        try {
            ...
            if ($action === 'create') {
                ...
                header('Location: ' . BASE_PATH . '/app/pages/venues/index.php');
                exit;
            }
...
renderPageStart($editVenue ? 'Edit Venue' : 'Add Venue', [
    'bodyClass' => 'is-flex is-flex-direction-column is-fullheight',
    'extraScripts' => ['<script type="module" src="' . BASE_PATH . '/app/public/js/venue-form.js" defer></script>']
]);
?>
            ...
            <form method="POST" action="" class="columns is-multiline">
              ...
              <div class="column is-12">
                <div class="buttons">
                  ...
                  <a href="<?php echo BASE_PATH; ?>/app/pages/venues/index.php" class="button">Cancel</a>
                </div>
              </div>
            </form>
          </div>
