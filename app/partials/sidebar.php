  ...
  <div class="is-flex is-flex-direction-column is-justify-content-space-between is-fullheight p-3">
    <nav class="menu">
      <ul class="menu-list">
        ...
        <li>
          <a href="<?php echo BASE_PATH; ?>/app/controllers/venues/index.php" class="<?php echo $isVenues ? 'is-active' : ''; ?>" aria-label="Venues">
        ...
        <?php if (($currentUser['role'] ?? '') === 'admin'): ?>
          <li>
            <a href="<?php echo BASE_PATH; ?>/app/controllers/admin/index.php" class="<?php echo $isAdmin ? 'is-active' : ''; ?>" aria-label="Admin">
